		...
		columns: [{
			...
			renderer: function (value, metaData, record, rowIndex, colIndex) {
				...
				if (value.toUpperCase() == 'ACTIVATING' || value.toUpperCase() == 'RUNNING') {
					...
					return '<input id="checkbox' + rowIndex + '" name="checkbox" type="checkbox" class="taskCheckbox" style="visibility: visible;" value="' + rowIndex + '" disabled >';
				} else {
					return '<input id="checkbox' + rowIndex + '" name="checkbox" type="checkbox" class="taskCheckbox" style="visibility: visible;" value="' + rowIndex + '" onclick="OnClickCheck(' + rowIndex + ');OnStopBubble(this);">';
				}
			}
		}, {
			text: '源名',
			...
			renderer: function (value, metaData, record, rowIndex, colIndex) {
				...
				} if (value.toUpperCase() == 'ACTIVATING') {
...
function ReSetWindowViewSize(isPostBacked) {
	...
	$('#TaskManage').height(defHeight - 130);
	$('#pnlGirdView').height(defHeight - 240);
	...
	if (isPostBacked == true) {
		...
		//调整大小
		$('div.x-grid-body').height(defHeight - 261);
		$('div.x-grid-view').height(defHeight - 273);
	}
};
